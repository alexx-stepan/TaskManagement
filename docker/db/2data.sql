...
INSERT INTO tm.PROJECTS(name) VALUES ('TestProj1');
INSERT INTO tm.PROJECTS(name) VALUES ('TestProj2');

INSERT INTO tm.TASKS (parent_task_id, assignee_id, title, description, priority, project_id) VALUES (null, 1, 'Create report on performance of your subordinates', 'some description', 'High', 1);
INSERT INTO tm.TASKS (parent_task_id, assignee_id, title, description, priority, project_id) VALUES (null, 2, 'Implement LoginController', 'some description', 'Low', 2);
INSERT INTO tm.TASKS (parent_task_id, assignee_id, title, description, priority, project_id) VALUES (2, 2, 'Include Security module into project', 'some description', 'Medium', 2);
